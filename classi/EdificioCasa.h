//Esempioutilesulconcettodiereditarietà
#include <iostream> 
using namespace std;
class edificio {
	int stanze;
	int piani;
	int superficie;
public: void imposta_stanze(int);
	  int prendi_stanze();
